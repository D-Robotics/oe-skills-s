...
- `hb_config_generator` 命令与配置编写见 `../horizon_tc_ui/horizon-tc-ui/references/tasks/task-yaml-authoring.md`
- `hb_compile` 主流程与验证见 `../horizon_tc_ui/horizon-tc-ui/references/tasks/task-float-to-hbm.md`
...
| "用随机数据快速估算模型性能" | `horizon-tc-ui` fast-perf | 只做性能估算，不冒充 PTQ 量化 |

#!/bin/bash
# OE-LLM 包本地安装脚本
# 用法: bash .horizon/skills/drobotics-router/oe-llm-package-install/install.sh <OE_LLM_DIR>
# 示例: bash .horizon/skills/drobotics-router/oe-llm-package-install/install.sh /mnt/oe-cli-test/horizon_j6_open_explorer_llm_v2.0.0_rc3-py310_20260615
set -euo pipefail

#!/bin/bash
# OE 包本地安装脚本
# 用法: bash .horizon/skills/drobotics-router/oe-package-install/install.sh <OE_DIR>
# 示例: bash .horizon/skills/drobotics-router/oe-package-install/install.sh /mnt/oe-cli-test/horizon_j6_open_explorer_v3.9.0_rc4-py310_20260326
set -euo pipefail
